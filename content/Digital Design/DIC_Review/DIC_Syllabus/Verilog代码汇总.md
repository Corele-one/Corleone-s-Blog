...
### Verilog基础
- [[01_Verilog|Verilog]]：2 个代码块
- [[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]：19 个代码块
- [[03_MUX2_1-结构-数据-行为-tb|MUX2_1-结构-数据-行为-tb]]：4 个代码块

### 组合逻辑
- [[02_译码器和多路复用器|译码器和多路复用器]]：12 个代码块
- [[01_三态门|三态门]]：2 个代码块
- [[02_优先编码器|优先编码器]]：3 个代码块
- [[03_异或门和奇偶校验功能|异或门和奇偶校验功能]]：3 个代码块
- [[04_比较器|比较器]]：4 个代码块
- [[03_乘法器|乘法器]]：1 个代码块
- [[01_加法器和减法器|加法器和减法器]]：7 个代码块
- [[02_移位和旋转|移位和旋转]]：1 个代码块
- [[CH9 状态机设计/关于无效状态的处理|关于无效状态的处理]]：2 个代码块
- [[01_Verilog状态机编码风格|Verilog状态机编码风格]]：1 个代码块
- [[Exam_topic]]：3 个代码块
- [[某个老师的测试题]]：2 个代码块

### 时序逻辑
- [[02_移位和旋转|移位和旋转]]：3 个代码块
- [[04_用verilog设计状态机|用verilog设计状态机]]：1 个代码块
- [[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]：15 个代码块
- [[02_移位寄存器|移位寄存器]]：11 个代码块
- [[01_计数器|计数器]]：6 个代码块
- [[04_1计数器|"1"计数器]]：3 个代码块
- [[01_Verilog状态机编码风格|Verilog状态机编码风格]]：1 个代码块
- [[03_序列发生器|序列发生器]]：3 个代码块
- [[05_序列检测器|序列检测器]]：2 个代码块
- [[02_状态机示例1|状态机示例1]]：3 个代码块
- [[Exam_topic]]：4 个代码块

## Verilog基础

### 来源：[[01_Verilog|Verilog]]

#### 1. my_module

- 分类：Verilog基础
- 来源：[[01_Verilog|Verilog]]，代码块位置 L70-L85
- 上下文：1. 声明模块时的端口声明
- 模块名：`my_module`
...
- 分类：Verilog基础
- 来源：[[01_Verilog|Verilog]]，代码块位置 L100-L114
- 上下文：2. 实例化模块时的端口连接
- 模块名：`top`
...
### 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]

#### 3. 结构化模型

- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L11-L19
- 上下文：结构化模型
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L32-L41
- 上下文：结构化模型
- 模块名：`Inh`
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L47-L59
- 上下文：结构化模型
- 模块名：`VrXOR`
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L76-L83
- 上下文：例子
- 模块名：`prime`
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L86-L94
- 上下文：例子
- 模块名：`bytesel`
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L102-L119
- 上下文：always语句块
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L126-L133
- 上下文：推理产生的锁存器
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L137-L146
- 上下文：推理产生的锁存器
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L153-L156
- 上下文：赋值语句
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L162-L167
- 上下文：赋值语句
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L171-L173
- 上下文：赋值语句
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L177-L180
- 上下文：赋值语句
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L193-L198
- 上下文：赋值语句
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L202-L204
- 上下文：赋值语句
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L208-L211
- 上下文：赋值语句
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L238-L260
- 上下文：if-else
- 模块名：`Vrprimei`
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L286-L300
- 上下文：循环语句
- 模块名：`comp`
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L306-L321
- 上下文：循环语句
...
- 分类：Verilog基础
- 来源：[[02_Verilog模型以及测试平台|Verilog模型以及测试平台]]，代码块位置 L339-L353
- 上下文：测试平台(testbench)
- 模块名：`prime_tb1`
...
### 来源：[[03_MUX2_1-结构-数据-行为-tb|MUX2_1-结构-数据-行为-tb]]

#### 22. mux2_1

- 分类：Verilog基础
- 来源：[[03_MUX2_1-结构-数据-行为-tb|MUX2_1-结构-数据-行为-tb]]，代码块位置 L5-L15
- 上下文：用结构化模型来描述该电路
- 模块名：`mux2_1`
...
- 分类：Verilog基础
- 来源：[[03_MUX2_1-结构-数据-行为-tb|MUX2_1-结构-数据-行为-tb]]，代码块位置 L19-L27
- 上下文：用数据流模型来描述
- 模块名：`mux2_1`
...
- 分类：Verilog基础
- 来源：[[03_MUX2_1-结构-数据-行为-tb|MUX2_1-结构-数据-行为-tb]]，代码块位置 L31-L44
- 上下文：用行为化模型
- 模块名：`mux2_1`
...
- 分类：Verilog基础
- 来源：[[03_MUX2_1-结构-数据-行为-tb|MUX2_1-结构-数据-行为-tb]]，代码块位置 L54-L69
- 上下文：testbench
- 模块名：`mux_tb`
...
### 来源：[[02_译码器和多路复用器|译码器和多路复用器]]

#### 26. decode2_4

- 分类：组合逻辑
- 来源：[[02_译码器和多路复用器|译码器和多路复用器]]，代码块位置 L59-L71
- 上下文：结构化描述
- 模块名：`decode2_4`
...
- 分类：组合逻辑
- 来源：[[02_译码器和多路复用器|译码器和多路复用器]]，代码块位置 L75-L85
- 上下文：数据流描述
- 模块名：`decode2_4`
...
- 分类：组合逻辑
- 来源：[[02_译码器和多路复用器|译码器和多路复用器]]，代码块位置 L94-L114
- 上下文：行为化描述
- 模块名：`decode2_4`
...
- 分类：组合逻辑
- 来源：[[02_译码器和多路复用器|译码器和多路复用器]]，代码块位置 L118-L134
- 上下文：行为化描述
- 模块名：`decode2_4`
...
- 分类：组合逻辑
- 来源：[[02_译码器和多路复用器|译码器和多路复用器]]，代码块位置 L138-L151
- 上下文：行为化描述
- 模块名：`decode2_4`
...
- 分类：组合逻辑
- 来源：[[02_译码器和多路复用器|译码器和多路复用器]]，代码块位置 L163-L166
- 上下文：testbench的设计
...
- 分类：组合逻辑
- 来源：[[02_译码器和多路复用器|译码器和多路复用器]]，代码块位置 L169-L171
- 上下文：testbench的设计
...
- 分类：组合逻辑
- 来源：[[02_译码器和多路复用器|译码器和多路复用器]]，代码块位置 L175-L177
- 上下文：testbench的设计
...
- 分类：组合逻辑
- 来源：[[02_译码器和多路复用器|译码器和多路复用器]]，代码块位置 L196-L225
- 上下文：七段译码器的verilog程序
- 模块名：`segdec`
...
- 分类：组合逻辑
- 来源：[[02_译码器和多路复用器|译码器和多路复用器]]，代码块位置 L275-L283
- 上下文：数据流描述
- 模块名：`mux2in8`
...
- 分类：组合逻辑
- 来源：[[02_译码器和多路复用器|译码器和多路复用器]]，代码块位置 L287-L300
- 上下文：行为级描述
- 模块名：`mux2in8`
...
- 分类：组合逻辑
- 来源：[[02_译码器和多路复用器|译码器和多路复用器]]，代码块位置 L304-L323
- 上下文：行为级描述
- 模块名：`mux4in8`
...
- 分类：组合逻辑
- 来源：[[02_优先编码器|优先编码器]]，代码块位置 L33-L52
- 上下文：用for语句简化if
- 模块名：`priencoder`
...
- 分类：组合逻辑
- 来源：[[02_优先编码器|优先编码器]]，代码块位置 L67-L87
- 上下文：行为级case
- 模块名：`Vr8inprior4`
...
- 分类：组合逻辑
- 来源：[[02_优先编码器|优先编码器]]，代码块位置 L91-L111
- 上下文：行为级case
- 模块名：`Vr8inprior4`
...
### 来源：[[03_异或门和奇偶校验功能|异或门和奇偶校验功能]]

#### 43. XOR3

- 分类：组合逻辑
- 来源：[[03_异或门和奇偶校验功能|异或门和奇偶校验功能]]，代码块位置 L45-L52
- 上下文：三输入异或、数据流描述
- 模块名：`XOR3`
...
- 分类：组合逻辑
- 来源：[[03_异或门和奇偶校验功能|异或门和奇偶校验功能]]，代码块位置 L56-L69
- 上下文：9输入奇校验电路的行为级描述
- 模块名：`parity9`
...
- 分类：组合逻辑
- 来源：[[03_异或门和奇偶校验功能|异或门和奇偶校验功能]]，代码块位置 L75-L87
- 上下文：结构级描述(Structral)
- 模块名：`parity9`
...
### 来源：[[01_加法器和减法器|加法器和减法器]]

#### 51. 半加器

- 分类：组合逻辑
- 来源：[[01_加法器和减法器|加法器和减法器]]，代码块位置 L6-L9
- 上下文：半加器
...
- 分类：组合逻辑
- 来源：[[01_加法器和减法器|加法器和减法器]]，代码块位置 L14-L16
- 上下文：半加器
...
- 分类：组合逻辑
- 来源：[[01_加法器和减法器|加法器和减法器]]，代码块位置 L39-L45
- 上下文：减法器
...
- 分类：组合逻辑
- 来源：[[01_加法器和减法器|加法器和减法器]]，代码块位置 L111-L121
- 上下文：参数化设计，数据流描述
- 模块名：`VrAdder`
...
- 分类：组合逻辑
- 来源：[[01_加法器和减法器|加法器和减法器]]，代码块位置 L128-L140
...
- 分类：组合逻辑
- 来源：[[01_加法器和减法器|加法器和减法器]]，代码块位置 L144-L155
- 上下文：复用的加法器模块
- 模块名：`VrSelAdder`
...
- 分类：组合逻辑
- 来源：[[01_加法器和减法器|加法器和减法器]]，代码块位置 L163-L171
- 上下文：数据流描述的复用加法器模块
- 模块名：`VrSelAdder`
...
- 分类：组合逻辑
- 来源：[[02_移位和旋转|移位和旋转]]，代码块位置 L110-L121
- 上下文：用算数右移与符号位拓展
...
### 来源：[[01_Verilog状态机编码风格|Verilog状态机编码风格]]

#### 61. 次态与输出逻辑合并

- 分类：组合逻辑
- 来源：[[01_Verilog状态机编码风格|Verilog状态机编码风格]]，代码块位置 L85-L110
- 上下文：次态与输出逻辑合并
...
- 分类：时序逻辑
- 来源：[[02_移位和旋转|移位和旋转]]，代码块位置 L25-L33
- 上下文：循环左移桶形移位器-行为级描述
...
- 分类：时序逻辑
- 来源：[[02_移位和旋转|移位和旋转]]，代码块位置 L35-L53
- 上下文：循环左移桶形移位器-行为级描述
- 模块名：`Vrrol16`
...
- 分类：时序逻辑
- 来源：[[02_移位和旋转|移位和旋转]]，代码块位置 L57-L100
...
### 来源：[[04_用verilog设计状态机|用verilog设计状态机]]

#### 70. VrSmax

- 分类：时序逻辑
- 来源：[[04_用verilog设计状态机|用verilog设计状态机]]，代码块位置 L21-L68
...
### 来源：[[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]

#### 71. 请注意非阻塞赋值

- 分类：时序逻辑
- 来源：[[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]，代码块位置 L10-L22
- 上下文：请注意非阻塞赋值
...
- 分类：时序逻辑
- 来源：[[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]，代码块位置 L32-L43
- 上下文：D锁存器的行为化模型
- 模块名：`VeDlatch`
...
- 分类：时序逻辑
- 来源：[[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]，代码块位置 L49-L58
...
- 分类：时序逻辑
- 来源：[[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]，代码块位置 L62-L79
- 上下文：带锁存输出的n-s位译码器
- 模块名：`NtoSLatch`
...
- 分类：时序逻辑
- 来源：[[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]，代码块位置 L86-L94
- 上下文：D触发器的行为化模型
- 模块名：`DFF`
...
- 分类：时序逻辑
- 来源：[[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]，代码块位置 L97-L107
- 上下文：带异步清零端的D触发器
- 模块名：`VrDFFCLR`
...
- 分类：时序逻辑
- 来源：[[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]，代码块位置 L111-L122
...
- 分类：时序逻辑
- 来源：[[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]，代码块位置 L133-L143
- 上下文：带有Q_N输出的D触发器的错误模型
...
- 分类：时序逻辑
- 来源：[[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]，代码块位置 L146-L160
- 上下文：带有Q_N输出的D触发器的错误模型
- 模块名：`VrDffCNoops`
...
- 分类：时序逻辑
- 来源：[[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]，代码块位置 L166-L177
...
- 分类：时序逻辑
- 来源：[[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]，代码块位置 L190-L200
- 上下文：initial —— 执行一次
...
- 分类：时序逻辑
- 来源：[[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]，代码块位置 L208-L212
- 上下文：always —— 循环执行
...
- 分类：时序逻辑
- 来源：[[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]，代码块位置 L227-L240
- 上下文：时钟产生器的设计
- 模块名：`CLKGen`
...
- 分类：时序逻辑
- 来源：[[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]，代码块位置 L250-L274
- 上下文：内联
- 模块名：`tb_DFF`
...
- 分类：时序逻辑
- 来源：[[03_用verilog实现锁存器和触发器|用verilog实现锁存器和触发器]]，代码块位置 L280-L290
- 上下文：模块例化
- 模块名：`tb_DFF`
...
- 分类：时序逻辑
- 来源：[[02_移位寄存器|移位寄存器]]，代码块位置 L9-L30
...
- 分类：时序逻辑
- 来源：[[02_移位寄存器|移位寄存器]]，代码块位置 L45-L57
...
- 分类：时序逻辑
- 来源：[[02_移位寄存器|移位寄存器]]，代码块位置 L60-L80
- 上下文：并入串出寄存器(PISO)
- 模块名：`PISO`
...
- 分类：时序逻辑
- 来源：[[02_移位寄存器|移位寄存器]]，代码块位置 L87-L104
- 上下文：并入并出寄存器(PIPO)
- 模块名：`PIPO`
...
- 分类：时序逻辑
- 来源：[[02_移位寄存器|移位寄存器]]，代码块位置 L116-L136
...
- 分类：时序逻辑
- 来源：[[02_移位寄存器|移位寄存器]]，代码块位置 L154-L178
...
- 分类：时序逻辑
- 来源：[[02_移位寄存器|移位寄存器]]，代码块位置 L190-L197
- 上下文：环形计数器
...
- 分类：时序逻辑
- 来源：[[02_移位寄存器|移位寄存器]]，代码块位置 L231-L245
...
- 分类：时序逻辑
- 来源：[[02_移位寄存器|移位寄存器]]，代码块位置 L264-L274
- 上下文：自同步逻辑拆解
...
- 分类：时序逻辑
- 来源：[[02_移位寄存器|移位寄存器]]，代码块位置 L287-L299
...
- 分类：时序逻辑
- 来源：[[02_移位寄存器|移位寄存器]]，代码块位置 L374-L398
- 上下文：LFSR的Verilog模型
- 模块名：`LFSR`
...
- 分类：时序逻辑
- 来源：[[04_1计数器|"1"计数器]]，代码块位置 L13-L67
- 上下文：三段式编码(不利用加法功能)
- 模块名：`counter_1`
...
- 分类：时序逻辑
- 来源：[[04_1计数器|"1"计数器]]，代码块位置 L71-L105
...
- 分类：时序逻辑
- 来源：[[04_1计数器|"1"计数器]]，代码块位置 L109-L134
- 上下文：将状态存储和次态逻辑组合到一起
- 模块名：`VronescntSMa`
...
- 分类：时序逻辑
- 来源：[[01_Verilog状态机编码风格|Verilog状态机编码风格]]，代码块位置 L118-L130
- 上下文：寄存器型输出/流水线输出*了解*
...
- 分类：时序逻辑
- 来源：[[03_序列发生器|序列发生器]]，代码块位置 L8-L21
...
- 分类：时序逻辑
- 来源：[[03_序列发生器|序列发生器]]，代码块位置 L34-L65
- 上下文：法2: 计数器 + 组合逻辑查表
- 模块名：`seq_gen_counter`
...
- 分类：时序逻辑
- 来源：[[03_序列发生器|序列发生器]]，代码块位置 L79-L129
...
- 分类：时序逻辑
- 来源：[[05_序列检测器|序列检测器]]，代码块位置 L11-L45
- 上下文：1. 先画状态转移图
- 模块名：`fsm`
...
- 分类：时序逻辑
- 来源：[[05_序列检测器|序列检测器]]，代码块位置 L68-L103
...
- 分类：时序逻辑
- 来源：[[02_状态机示例1|状态机示例1]]，代码块位置 L5-L77
- 上下文：Ex.1
- 模块名：`FSM1`
...
- 分类：时序逻辑
- 来源：[[02_状态机示例1|状态机示例1]]，代码块位置 L99-L105
- 上下文：同步复位
...
- 分类：时序逻辑
- 来源：[[02_状态机示例1|状态机示例1]]，代码块位置 L109-L115
- 上下文：异步复位
